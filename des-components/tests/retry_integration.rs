...
use des_components::tower::{DesServiceBuilder, DesRetryLayer, DesRetryPolicy, ServiceError, SimBody};
...
fn test_tower_scheduler_handle_attempt_creation() {
    ...
    let retry_meta = des_components::tower::retry::RetryMetadata::new(original_request_id)
        .next_attempt(); // This would be attempt 2
